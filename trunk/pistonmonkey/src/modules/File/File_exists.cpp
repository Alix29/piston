...
JSBool File_function_exists_internal(JSContext * cx, char * path, jsval * rval)
{
...
LM_FUNCTION(File_function_exists_static, "static File.exists")
	...
	return File_function_exists_internal(cx, path, rval);
}

LM_FUNCTION(File_function_exists, "File.exists")
